...
set LDFLAGS=-mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=hard -u printf_float --specs=nano.specs --specs=nosys.specs -T"%PROJECT_ROOT%\STM32F334R8Tx_FLASH.ld" -Wl,--gc-sections
