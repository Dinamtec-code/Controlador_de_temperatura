...
#define SDIN_BUFFER_SIZE 64
  ...
  typedef struct C_BUFFER_HANDLER
  {
    ...
    size_t BufferLength;
    size_t BufferStartOffset; /* El encargado de cambiar el offset es la interrupci�n sobre el final de la transmisi�n*/
    size_t BufferEndOffset;   /* Es la posici�n donde se va a escribir el pr�ximo dato */
    size_t ToSend;
