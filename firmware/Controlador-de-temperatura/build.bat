...
REM Requires ARM toolchain at: C:\Program Files (x86)\Arm\GNU Toolchain mingw-w64-i686-arm-none-eabi\bin
...
for %%f in (Core\Src\main.c Core\Src\stm32f3xx_it.c Core\Src\stm32f3xx_hal_msp.c Core\Src\system_stm32f3xx.c Core\Src\syscalls.c Core\Src\usart.c Core\Src\hrtim.c Core\Src\adc.c Core\Src\gpio.c Core\Src\dma.c Core\Src\hardware\circular_buffer.c Core\Src\hardware\usart_hw.c Core\Src\hardware\adc_hw.c Core\Src\hardware\lcd_hw.c Core\Src\hardware\hrtim_hw.c Core\Src\hardware\i2c_hw.c Core\Src\tasks\scheduler.c Core\Src\tasks\task_comm.c Core\Src\tasks\task_system.c Core\Src\tasks\task_control.c Core\Src\tasks\task_ui.c Core\Src\services\scpi_parser.c Core\Src\services\error_handler.c Core\Src\control\pid_controller.c) do (
    echo Compiling %%f
...
echo Linking...
%ARM_BIN%\arm-none-eabi-gcc.exe %LDFLAGS% -Wl,-Map=Controlador-de-temperatura.map -Wl,--print-memory-usage -o Controlador-de-temperatura.elf *.o
